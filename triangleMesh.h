...
public:
	...
	void print(){
			std::cout << "Vertex cordinates: " << vtxi << ", " << vtxj << " , " << vtxk << std::endl;
	}
...
void TriangleMesh::scale_model(){
	for(int i = 0; i < indices.size(); i++){
		TriangleIndices triangle = indices[i];
		vertices[triangle.vtxi] = vertices[triangle.vtxi] * 0.6 + Vector(0, -10, 0);
...
bool TriangleMesh::intersection(Ray ray, Intersection& rec) const{
